...
@Component({
  selector: 'app-sidebar-derecho',
  templateUrl: './sidebar-derecho.component.html',
  styleUrls: ['./sidebar-derecho.component.scss']
})
export class SidebarDerechoComponent implements OnInit {
  ...
  constructor(
    private sidebarDerechoService: SidebarService,
  ...
  ngOnInit(): void {
    ...
    this.sidebarDerechoService.add(sidebarComponentData);
  }
  ngOnDestroy() {
    this.sidebarDerechoService.remove(this.id);
    this.element.remove();
  }
